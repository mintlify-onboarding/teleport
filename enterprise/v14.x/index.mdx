...
<Warning>
  This chapter covers an upcoming release: 14.x. We recommend the [latest](/enterprise/v13.x/index) version instead.
</Warning>
...
guide](/images/linux-server-diagram-8c0641fd81.webp)
...
<Snippet file="/tls-certificate-setup.mdx" />

#### Start Teleport

<Snippet file="/start-teleport.mdx" />
...
![Teleport Welcome Screen](/images/welcome-79f3654310.webp)
...
![Adding resources](/images/add-resources-cf0b3256e6.webp)
